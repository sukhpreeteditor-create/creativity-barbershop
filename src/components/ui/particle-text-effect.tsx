...
const DEFAULT_WORDS = ["BA.CUTZ", "HOUSECALLS", "CERTIFIED", "PREMIUM", "HAIRCUTS"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    offscreenCtx.font = "bold 120px Inter, sans-serif"
    ...
    const newColor = {
      r: Math.random() * 155 + 100, // Brighter colors
  ...
  useEffect(() => {
    ...
    const handleMouseDown = (e: MouseEvent) => {
      ...
      // Adjust scale if canvas CSS size differs from its intrinsic 1000x400 size
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full bg-[#0a0a0a] py-20 px-4 mt-auto">
      <canvas
        ref={canvasRef}
      ...
      <div className="mt-8 text-gray-500 text-sm md:text-base text-center max-w-md font-medium tracking-wide uppercase">
        <p className="mb-2">Ba.Cutz Hair Art</p>
